        ...
        <div class="top-right">
            ...
            <div class="attention">
                ...
                <a class="weixin" href="javascript:;">
                    <img src="static/images/top-icon01.png" alt=""/>
                    <div class="weixin-erweima">
                        <i></i>
                        <img src="static/images/erweima.png" alt=""/>
                    </div>
                </a>
                <a class="xl" href="javascript:;"><img src="static/static/images/top-icon02.png" alt=""/></a>
                <a class="tx" href="javascript:;"><img src="static/images/top-icon03.png" alt=""/></a>
                <span>|</span>
            </div>
        ...
        <div class="content-reg">
            ...
            <div class="login-form">
                ...
                <div class="login-left">
                    <img src="static/images/login-pic.png" alt="">
                </div>
                <!-- 登录右 -->
                <div class="login-right">
                    <form id="loginForm">
                        <div class="controls">
                            ...
                            <input type="text" class="input03 w400" name="uName" id="uName">
                        </div>
                        <div class="controls">
                            <div class="login-controls">
                                <p>密码：</p>
                            ...
                            <input type="text" class="input03 w400" name="uPwd" id="uPwd">
                        </div>
                        <div class="controls">
                            <div class="login-controls">
                                <p>验证码：</p>
                            </div>
                            <input type="text" class="input03 w250" name="verification" id="verification">
                            <img src="user/checkCode" alt="" class="code-img" style="height:43px;cursor:pointer;" onclick="this.src=this.src+'?'">
                           <!--  <a href="javascript:;" class="code-change">换一张</a> -->
                        </div>
                        <span id="loginCheck" style="color:red;font-size:18px;"></span>  
                        <div class="controls">
	...
	$(function(){
		$("#loginBtn").click(function(){
			...
			$.ajax({
				url:"user/checkLogin",
			/* 	type:"POST", */
				data:$("#loginForm").serialize()+"&verification"+verification,
				success:function(result){
					...
					if(result.code == 200){
						$("#loginCheck").html(result.extend.message);
					}
				}
			})
		})
