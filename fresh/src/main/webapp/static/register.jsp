...
<body>
	...
	<div class="top">
		<div class="container">
			<div class="top-left">
				<p>欢迎来到超鲜网</p>
				<a href="user/login">请登录</a> <span>|</span> <a href="javascript:;">免费注册</a>
			</div>
			<div class="top-right">
				<ul>
				...
				<div class="attention">
					...
					<a class="weixin" href="javascript:;"> <img
						src="static/static/images/top-icon01.png" alt="" />
						<div class="weixin-erweima">
							<i></i> <img src="static/images/erweima.png" alt="" />
						</div>
					</a> <a class="xl" href="javascript:;"><img
						src="static/images/top-icon02.png" alt="" /></a> <a class="tx"
						href="javascript:;"><img src="static/images/top-icon03.png" alt="" /></a>
					<span>|</span>
				</div>
	...
	<header>
		<div class="container">
			<a href="javascript:;" class="logo"> <img src="static/images/logo.png"
				alt="" />
			</a>
			<div class="search">
			...
			<div class="content-reg">
				...
				<div class="reg-tit">
					...
					<div class="reg-progress">
						<span class="selected">填写信息</span> <i
							class="fa fa-angle-double-right"></i> <span>注册成功</span>
					</div>
				</div>
				<!-- 注册表单 -->
				<div class="reg-form">
					<form action="user/regSubmit" method="post" id="myForm"  onsubmit="return clickSub()">
						<div class="controls">
							<p>用户名：</p>
							<input type="text" class="input03 w450" name="uName" id="uName"><span id="uNameSapn"></span>
						</div>
						<div class="controls">
							<p>密码：</p>
							<input type="password" class="input03 w450" name="uPwd" id ="uPwd"><span id="uPwdSpan"></span>
						</div>
						<div class="controls">
							<p>确认密码：</p>
							<input type="password" class="input03 w450" name="newPwd" id="newPwd"><span id="newPwdSpan"></span>
						</div>
						<div class="controls">
							<p>手机号：</p>
							<input type="text" class="input03 w450" name="phone" id="phone"><span id="phoneSpan"></span>
						</div>
						<div class="controls">
						...
						<div class="controls">
							...
							<div class="pact-radio" style="margin-left: 180px;">
								<input type="checkbox" id="checkBox"/> <a href="javascript:;" class="pact">《超鲜网用户协议》</a><span id="checkBoxSpan"></span>
							</div>
	...
	<div class="thickbox">
		...
		<div class="thickcon" id=""
			style="width: 922px; height: 450px; padding-left: 0px; padding-right: 0px; border-left-width: 1px; border-right-width: 1px;">
			<div class=" regist-2013">
				<div class="regist-bor">
					<div class="mc">
						...
						<div class="btnt btn07">同意并继续</div>
					</div>
				</div>
			</div>
		</div>
	...
	<script>
		...
		function checkUname(uName){
			...
			$.ajax({
				...
				success:function(result){
					// 可以添加
					$("#uNameSapn").html(""); 
					if(result.code == 100 && uName != ""){
						$("#uNameSapn").html("用户名可用").css("color","green");
						flag = true;
					}
					if(result.code == 200 && uName != ""){
						$("#uNameSapn").html("用户名不可用 ").css("color", "red");
						flag = false;
					}
				}
			})
		...
		$("#uPwd,#newPwd").on("change",function(){
			uPwdCheck();
			newPwdCheck();
		})
		...
		function uPwdCheck(){
			...
			oldPwd = uPwd;
			if(uPwd == ""){
				return checkHtml("#uPwdSpan",false);
			}else{
				return checkHtml("#uPwdSpan",true);
			}
		}
		...
		function newPwdCheck(){
			...
			var oldPwd = $("#uPwd").val();
			if(newPwd == ""){
				return checkHtml("#newPwdSpan",false);
			}
			if(newPwd == oldPwd){
				return checkHtml("#newPwdSpan",true);
			}else{
				$("#newPwdSpan").html("两次密码不一致").css("color", "red");
			}
		}
		...
		function phoneCheck(){
			var phone = $("#phone").val();
			if(phone == ""){
				return checkHtml("#phoneSpan",false);
			}else{
				return checkHtml("#phoneSpan",true);
			}
		}
		function checkHtml(ele,flag){
			if(flag){
				$(ele).html("✔").css("color", "green");
				return true;
			}else{
				$(ele).html("✖ ").css("color", "red");
				return false;
			}
		}
		...
		function checkBox(){
			...
			if(!$("#checkBox").is(':checked')){
				$("#checkBoxSpan").html("请勾选用户协议").css("color","red");
			}
		}
		...
		function clickSub(){
			...
			if(flag && uPwdCheck() && newPwdCheck() && phoneCheck()){
				return true;
			}
			return false;
		}
